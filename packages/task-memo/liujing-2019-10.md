...
## 贝分期 1.4.0
    +:
      刘晶:
        - 控台订单管理任务拆分(0.5d)
      张翔:
        - 开发和配置订单数据可见权限控制： 细分金融顾问和管理员(0.5d)
        - 订单管理后台-查询表单UI布局开发(0.5d)
        - 订单管理后台-列表页面UI布局开发(0.5d)
        - 订单管理后台-详情页面基本UI布局开发(0.5d)
        - 订单管理后台-详情页面模块可见度支持权限可配(0.5d)
        - 订单管理后台-申请信息-客户信息UI布局开发(0.5d)
        - 订单管理后台-申请信息-申请单信息UI布局开发(0.5d)
        - 订单管理后台-申请信息-影像列表UI布局开发(0.5d)
        - 订单管理后台-借款信息-放款信息UI布局开发(0.5d)
        - 订单管理后台-借款信息-费用信息UI布局开发(0.5d)
        - 订单管理后台-借款信息-还款计划UI布局开发(0.5d)
        - 订单管理后台-借款信息-还款记录UI布局开发(0.5d)
        - 订单管理后台-查询列表页面-API mock和对接(0.5d)
        - 订单管理后台-申请信息-API mock和对接(0.5d)
        - 订单管理后台-详情页面-API mock和对接(0.5d)
        - 订单管理后台-查询列表页面-API 联调(0.5d)
        - 订单管理后台-申请信息-API 联调(0.5d)
        - 订单管理后台-详情页面-API 联调(0.5d)
